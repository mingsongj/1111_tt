...
// Esteban complete the `timeout` modification - DONE
// completed adding sensor flag, Esteban, 10/9/2023

// receive command "command_type, timeout, sensor_flag", eg., you call "i,20,1" to output the power, call "i,20,0" to block the power output.
...
void reset_command(){
  // reset the pneumatic command but leave the sensor flag. 
      command_type = "";
      timeout = 0;
}
